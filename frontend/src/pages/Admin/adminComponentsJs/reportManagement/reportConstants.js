...
export const suspensionPeriods = [
  {
    label: "1일",
    value: 1,
    description: "24시간 동안 계정 이용이 제한됩니다.",
  },
  {
    label: "3일",
    value: 3,
    description: "72시간 동안 계정 이용이 제한됩니다.",
  },
  {
    label: "7일",
    value: 7,
    description: "168시간 동안 계정 이용이 제한됩니다.",
  },
  {
    label: "30일",
    value: 30,
    description: "720시간 동안 계정 이용이 제한됩니다.",
  },
  {
    label: "직접 입력",
    value: "custom",
    description: "원하는 기간을 직접 입력해주세요.",
  },
];
