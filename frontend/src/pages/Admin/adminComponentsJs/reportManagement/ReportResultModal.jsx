...
export function ReportResultModal({ report, onClose }) {
  ...
  return (
    <div className={styles.resultOverlay} role="dialog" aria-modal="true" aria-label="신고 처리 결과 조회">
      {/* 처리 결과 팝업 배경 ---------------------------------- */}
      <button className={styles.resultDimmedArea} type="button" aria-label="처리 결과 팝업 닫기" onClick={onClose} />
      ...
      <section className={styles.resultModal}>
        ...
        <header className={styles.resultHeader}>
          ...
          <button className={styles.iconButton} type="button" aria-label="처리 결과 팝업 닫기" onClick={onClose}>
            <CloseOutlinedIcon />
          </button>
        </header>
